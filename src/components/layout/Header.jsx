    ...
    <div className=" w-full lg:h-20 h-12  border-gray-500 px-2  bg-white ">
      <div className="h-full max-w-screen-2xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden lg:inline-flex items-center gap-8 text-sm uppercase font-semibold tracking-wide">
          ...
          <Link href={"/contact"}>
            <button className="pt-2 w-40 h-10  text-lg font-mirza bg-yellow-400 italic  text-black uppercase rounded hover:bg-black hover:text-white duration-300 tracking-wide">
              START A QUOTE +
            </button>
          </Link>
        </div>
