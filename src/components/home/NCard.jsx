...
const NCard = ({ title, image, p, p1, lin }) => {
  return (
    <FadeIn>
      <div className=" md:pt-32 lg:pt-10 lg:pb-10 lg:mt-4 pb-4  bg-gray-100">
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div className="hidden lg:block lg:ml-32 md:mt-24">
          ...
          <div className="lg:pl-12 mt-2 md:mt-0 px-4 lg:w-72 sm:w-[96] md:pl-0 lg:pr-1">
          ...
          <div className="hidden lg:flex lg:pl-[18rem] align-center lg:-mt-36 gap-8">
            <Image
              src={"/c3.jpg"}
              alt="screen printing"
              width={200}
