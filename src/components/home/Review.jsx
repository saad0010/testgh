      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-4">
        <div className="p-10 sm:pl-52 md:p-0">
          <div className="relative flex w-full flex-col rounded-xl bg-slate-100 bg-clip-border text-gray-700 shadow-md">
            <div className="p-10">
              <h5 className="mb-6 block font-mirza text-xl md:text-5xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
                Customer reviews
              </h5>
              <p className="block mt-6 font-libre text-sm md:text-md font-light leading-relaxed text-inherit antialiased">
                ...
                ASAP, and everything was delivered on time and looked great. — I
                d highly recommend Tees Weather!
              </p>
            </div>
            <div className="p-6  ">
              {/* <button
