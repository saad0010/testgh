        ...
        <div className="p-10 md:pl-52 md:p-0">
          <div class="relative flex w-full flex-col rounded-xl bg-slate-100 bg-clip-border text-gray-700 shadow-md">
            <div class="p-10">
              ...
              <p class="block mt-6 font-sans text-md font-light leading-relaxed text-inherit antialiased">
                I used the online chat feature on their website to ask a few
                questions, which lead to placing an order the same day. I used
                their two day "Lightning Service" because the client needed
                shirts ASAP, and everything was delivered on time and looked
                great. — I'd highly recommend Tees Weather!
              </p>
            </div>
            <div class="p-6  ">
              {/* <button
            ...
            >
              ...
              <div className="flex">
                <div className="">
                  <Image
                    src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDd8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D"
                    alt=""
                    width={50}
                    height={100}
                ...
                <div className="ml-6 ">
                  <h4 className="font-semibold ">Chance C.</h4>
                  <h5 className="text-sm font-light mt-1">Easley,SC</h5>
